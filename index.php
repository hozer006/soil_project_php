...
<body>
    <div class="container ">
        ...
        <div class="row">
            <div class="col logo">
                <img src="assets/Logo 01-01.png" alt="">
                <h1>เครื่องวัดค่าตัวแปรดินแบบ IoT (IoT Soil Tester)</h1>
            </div>
        </div>
        <div>
            <h1> Statian 1</h1>
        ...
        <div style="text-align: center;">
            <a class="btn btn-outline-primary" href="dashboard.php?page=1">ดูตาราง</a>
        </div>
